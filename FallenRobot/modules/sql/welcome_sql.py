...
DEFAULT_WELCOME_MESSAGES = [
    "{first} holaa, sokap aja ya disini!",
    "haii admin ada yang baru nih, namanya {first}",
    "Welcome, {first} Disini aja yaa sayang.",
    "welcome, {first} Ikut gabung party disini yaa",
    "{first} ikut ramaikan gc ya sayang!",
    "{first} salam kenal beastie",
    "wih ada yang baru nih, salam kenal yaa",
    "{first} sokap-sokap aja ya disini",
    "{first} selamat bergabung beastiee",
    "{first} jangan sungkan yaa disini",
    "Welcome, {first}, pasti ganteng atau cantik nih huhu",
]
DEFAULT_GOODBYE_MESSAGES = [
    "{first} selamat jalan yaa",
    "{first} selamat tinggal",
    "{first} kenangan disini sungguh indah teman",
    "{first} sampai berjumpa lagi",
    "{first} keluar party kita",
    "{first} kepergianmu sungguh sedih",
    "{first} ditunggu kembali yaa",
    "Senang bertemu denganmu yaa, {first}!",
    "waktu denganmu menyenangkan {first}.",
    "aku berharap cepat bertemu lagi, {first}.",
    "aku akan merindukanmu {first}.",
    "Goodbye {first}! pasti akan rindu nih bot",
    "Goodbye {first}! bot kesepian lagi nih",
]
